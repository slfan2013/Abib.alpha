log_transformation = function(
  project_ID = "t2_68410298_1515789489480",
  expression_id ="expression_data_68410298_1515789489480_csv",
  log_base=10,
  use_pca = TRUE,
  ...
  core = log((e + sqrt(e^2 + 1)) * 0.5, base  = log_base)
  ...
  report = paste0(report, "We performed log (base=",log_base, ") data transformation on the _",strsplit(expression_id,"_68410298_")[[1]][1],"_ dataset. The transformed data is saved as _",filename,"/data_transformation-log2.xlsx_.\n\n")
