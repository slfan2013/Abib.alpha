nonparametric_two_way_mixed_anova_core = function(e,group1, group2,levels1, levels2,id_index,
                                    main_effect_1_post_hoc_test_type = "pairwise_nonparametric_paired_t_test_with_fdr",
                                    main_effect_2_post_hoc_test_type = "pairwise_nonparametric_t_test_with_fdr",
                                    simplemain_effect_1_post_hoc_test_type = "pairwise_nonparametric_paired_t_test_with_fdr",
                                    simplemain_effect_2_post_hoc_test_type = "pairwise_nonparametric_t_test_with_fdr"
){
  ...
  if(length(group1_indexes) == 2){
    ...
    anova1_core = nonparametric_repeated_anova_core(e, group1_indexes,id_index, post_hoc_test_type = main_effect_1_post_hoc_test_type)
  }
  # main effect 2
  if(length(group2_indexes) == 2){
    anova2_core = nonparametric_t_test_core(e, group2_indexes, direction = "two.sided")
  }else{
    anova2_core = nonparametric_anova_core(e, group2_indexes, post_hoc_test_type = main_effect_2_post_hoc_test_type)
  }
  ...
  for(i in 1:length(group2_indexes)){
    ...
    if(length(group1_indexes)==2){
      ...
      simple_main_effect_1[[i]] = nonparametric_repeated_anova_core(e = e., group_indexes = group1_indexes., id_index = id., post_hoc_test_type = simplemain_effect_1_post_hoc_test_type)
      colnames(simple_main_effect_1[[i]]) = paste0(names(simple_main_effect_1[[i]]), " @", names(group2_indexes[i]))
    }
  }
  ...
  for(i in 1:length(group1_indexes)){
    ...
    if(length(group2_indexes)==2){
      simple_main_effect_2[[i]] = nonparametric_t_test_core(e., group2_indexes., direction = "two.sided")
      colnames(simple_main_effect_2[[i]]) = paste0(names(simple_main_effect_2[[i]]), " @", names(group1_indexes[i]))
    }else{
      simple_main_effect_2[[i]] = nonparametric_anova_core(e., group2_indexes.,  post_hoc_test_type = simplemain_effect_2_post_hoc_test_type)
      colnames(simple_main_effect_2[[i]]) = paste0(names(simple_main_effect_2[[i]]), " @", names(group1_indexes[i]))
    }
  }
