nonparametric_two_way_anova_core = function(e,group1, group2,levels1, levels2,
                              main_effect_1_post_hoc_test_type = "pairwise_nonparametric_t_test_with_no_correction",
                              main_effect_2_post_hoc_test_type = "pairwise_nonparametric_t_test_with_no_correction",
                              simplemain_effect_1_post_hoc_test_type = "pairwise_nonparametric_t_test_with_no_correction",
                              simplemain_effect_2_post_hoc_test_type = "pairwise_nonparametric_t_test_with_no_correction"
){
  ...
  if(length(group1_indexes) == 2){
    anova1_core = nonparametric_t_test_core(e, group1_indexes, direction = "two.sided")
  }else{
    anova1_core = nonparametric_anova_core(e, group1_indexes, post_hoc_test_type = main_effect_1_post_hoc_test_type)
  }
  # main effect 2
  ...
  for(i in 1:length(group2_indexes)){
    ...
    if(length(group1_indexes)==2){
      simple_main_effect_1[[i]] = nonparametric_t_test_core(e., group1_indexes., direction = "two.sided")
      colnames(simple_main_effect_1[[i]]) = paste0(names(simple_main_effect_1[[i]]), " @", names(group2_indexes[i]))
    }else{
      simple_main_effect_1[[i]] = nonparametric_anova_core(e., group1_indexes.,  post_hoc_test_type = simplemain_effect_1_post_hoc_test_type)
      colnames(simple_main_effect_1[[i]]) = paste0(names(simple_main_effect_1[[i]]), " @", names(group2_indexes[i]))
    }
  }
