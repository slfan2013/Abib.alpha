subsetting = function(
  project_ID = "a5_68410298_1513568728148",
  type = "character",
  file1_id = "data_transformation-log2_68410298_1513568745969_xlsx",
  file2_id = "nonparametric t test_68410298_1513570529119_xlsx",
  file1_text = "data_transformation-log2.xlsx",
  file2_text = "sample_info.csv",
  group_name="treatment",
  levels=c("MeOH-frz", "ACN.IPA-frz", "MeOH.CHCl3-frz"),
  range_min=0,
  range_max=0.05,
  ...
  # subsetting the first file according to the second file.
  # first, detect is the user going to split by rows or columns by checking the label matching.
