two_way_mixed_anova = function(project_ID = "C_68410298_1516226987062",
                         ...
                         type = "Welch",
                         post_hoc_test_type1 = "pairwise_paired_t_test_with_no_correction",
                         post_hoc_test_type2 = "Games_Howell_test",
  ...
  core = two_way_mixed_anova_core(e,group1, group2,levels1, levels2,id_index,
